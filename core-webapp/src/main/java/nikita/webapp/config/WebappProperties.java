...
/**
 * Properties specific to nikita-noark5-core.
 * <p>
 * <p>
 ...
 */
@Configuration
@ConfigurationProperties(prefix = "nikita-noark5-core", ignoreUnknownFields = true)
...
public class WebappProperties {
    ...
    public static class Mail {
        ...
        private String from = "nikitaNoark5Core@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "nikitaNoark5Core API";

        private String description = "nikitaNoark5Core API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "nikitaNoark5Core";
    ...
    public static class Saml {
        ...
        @Value("${nikita-noark5-core.saml.idPMetadata}")
