 ...
 */
public class WebappRestTestJSON {
     ...
     */
    public static void main(final String... args) throws UnknownHostException, URISyntaxException, JsonProcessingException {
        ...
        String addressAuthentication = "http://" + address + ":" + port + SLASH + appName + "/doLogin";
        String addressApplication = "http://" + address + ":" + port + SLASH + appName + SLASH + HATEOAS_API_PATH + SLASH + NOARK_FONDS_STRUCTURE_PATH + SLASH;
        ...
        String fondsJson = mapper.writeValueAsString(fonds);

        logger.info("Writing the following JSON for Fonds " + fondsJson);
        ...
        /*
        String fondsResponse = new HttpEntity<String>(childFonds, createObjectHeaders);
